package com.reactnativesqlitestorage;
...
public class SqliteStorageModule extends ReactContextBaseJavaModule {
   ...
   * @throws Exception
   */
  private SQLiteDatabase openDatabase(String dbname, @Nullable CallbackContext cbc) throws Exception {
    ...
    File dbfile = this.getReactApplicationContext().getDatabasePath(dbname);
